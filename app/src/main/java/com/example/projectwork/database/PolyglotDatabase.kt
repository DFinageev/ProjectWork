...
@Database(entities = [PolyglotData::class], version = 2, exportSchema = false)
abstract class PolyglotDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: PolyglotDatabase? = null

        fun getInstance(context: Context): PolyglotDatabase {
            synchronized(this) {
